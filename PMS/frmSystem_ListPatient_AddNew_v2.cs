...
namespace PMS
{
    public partial class frmSystem_ListPatient_AddNew_v2 : DevExpress.XtraEditors.XtraForm
    {
        clsQLNguoiDung qlND;
        ...
        public frmSystem_ListPatient_AddNew_v2()
        {
            InitializeComponent();
        ...
        private void frmSystem_ListPatient_AddNew_v2_Load(object sender, EventArgs e)
        {
        ...
        //private void txtComment_ContentChanged(object sender, EventArgs e)
        //{
        //    if (((RichEditControl)sender).Text.Length > maxPos)
        //    {
        //        pos = txtComment.Document.CaretPosition;
        //        Undo();
        //    }
        //}
        //public void Undo()
        ...
        //    txtComment.RtfText = txtComment.Document.GetRtfText(txtComment.Document.CreateRange(0, maxPos));
        //    txtComment.Document.CaretPosition = pos;
        //    txtComment.ResumeLayout();
        //}
